...
public class menstrulCycleDetails {
    ...
    public menstrulCycleDetails(String username, Date startDate, Date endDate, String flow, Integer numberOfPads,
